...
fileName=fade_no_atmosphere.cfg
...
_textDefinition.file=fade_no_atmosphere.arbvp1
_entryPoint.value=vmain
_stateList.value = modelViewProj_VS, textureMatrix_VS, blendMorphVertexParams_VS
const = false
...
// File containing shader program. Default to ARB version.
_textDefinition.file=fade_no_atmosphere.arbfp1
