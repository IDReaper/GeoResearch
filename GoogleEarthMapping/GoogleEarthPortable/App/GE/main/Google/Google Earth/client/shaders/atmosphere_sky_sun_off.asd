...
/////////////////////////
[INTERFACE]
section=atmosphere_sky_sun_off
...
fileName=atmosphere_sky_sun_off.cfg
...
_textDefinition.file = atmosphere_sky_sun_off.arbvp1
_stateList.value = modelViewProj_VS, skySunOffVertexParams_VS
const = false
...
fields = _textDefinition, _stateList, _samplerList
// File containing shader program. Default to ARB version.
_textDefinition.file = atmosphere_sky_sun_off.arbfp1
_stateList.value = skySunOffPixelParams_PS
_samplerList.value = skyMap_PS
const = false
