...
/////////////////////////
[INTERFACE]
section=atmosphere_ground_sun_off
...
fileName=atmosphere_ground_sun_off.cfg
...
_textDefinition.file=atmosphere_ground_sun_off.arbvp1
...
// File containing shader program. Default to ARB version.
_textDefinition.file=atmosphere_ground_sun_off.arbfp1
_entryPoint.value=pmain
_samplerList.value = groundTexture_PS, blendTexture_PS, groundRayleighMap_PS
_stateList.value = atmosphereCustomColor_PS, groundFogColor_PS, \
    groundSunOffPixelParams_PS, blendUnpopPixelParams_PS
const = false
