...
/////////////////////////
[INTERFACE]
section=fade_sun_no_atmosphere
...
fileName=fade_sun_no_atmosphere.cfg
...
_textDefinition.file=fade_sun_no_atmosphere.arbvp1
_entryPoint.value=vmain
_stateList.value = \
    modelViewProj_VS, textureMatrix_VS, blendMorphVertexParams_VS, \
    cameraToSunDirAndExposure_VS, lightDirectionInModel_VS
const = false
...
// File containing shader program. Default to ARB version.
_textDefinition.file=fade_sun_no_atmosphere.arbfp1
_entryPoint.value=pmain
_samplerList.value = groundTexture_PS, blendTexture_PS
_stateList.value = blendUnpopPixelParams_PS
const = false
