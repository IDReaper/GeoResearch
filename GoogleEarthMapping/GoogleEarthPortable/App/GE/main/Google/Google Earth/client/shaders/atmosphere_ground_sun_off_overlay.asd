...
/////////////////////////
[INTERFACE]
section=atmosphere_ground_sun_off_overlay
...
fileName=atmosphere_ground_sun_off_overlay.cfg
...
_textDefinition.file=atmosphere_ground_sun_off_overlay.arbvp1
_entryPoint.value=vmain
_stateList.value = modelView_VS, modelViewProj_VS, worldOriginInView_VS,\
    textureMatrix_VS, dirToCameraAndFogDensity_VS, \
    groundSunOffVertexParams_VS, blendMorphVertexParams_VS
const = false
...
// File containing shader program. Default to ARB version.
_textDefinition.file=atmosphere_ground_sun_off_overlay.arbfp1
_entryPoint.value=pmain
_samplerList.value = groundTexture_PS, groundRayleighOverlayMap_PS
_stateList.value = groundFogColor_PS, groundSunOffPixelParams_PS, \
    atmosphereCustomColor_PS, groundOverlayExtent_PS
const = false
