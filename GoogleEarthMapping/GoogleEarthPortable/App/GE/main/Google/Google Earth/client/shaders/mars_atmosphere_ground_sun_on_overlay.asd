...
/////////////////////////
[INTERFACE]
section=mars_atmosphere_ground_sun_on_overlay

[mars_atmosphere_ground_sun_on_overlay]
attrs=
...
fileName=mars_atmosphere_ground_sun_on_overlay.cfg
...
_textDefinition.file=mars_atmosphere_ground_sun_on_overlay.arbvp1
...
// File containing shader program. Default to ARB version.
_textDefinition.file=mars_atmosphere_ground_sun_on_overlay.arbfp1
...
_stateList.value = atmosphereCustomState_PS, atmosphereCustomColor_PS,\
  fogColor_PS, groundOverlayExtent_PS
const = false
